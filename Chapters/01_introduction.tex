...
One strategy is to transform the model into a simpler, more interpretable proxy model which has the same local behaviour. In LIME \cite{ribeiroWhy2016}, a commonly used method, the proxy is a linear model.
...
While CFX seem helpful in improving trust in black-box machine learning models, further thought surfaces difficult problems that threaten the trustworthiness \emph{of the explanations themselves}.
...
The field of XAI in general suffers from a crisis of formalism. \citenote{}
