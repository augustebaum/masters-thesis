...
They are implemented in \texttt{pytorch}, and trained on one Nvidia G-Force i7-7800X GPU via CUDA 11.7.
...
\begin{table}[h!]
    \centering
    \subfile{../Figures/path_reg.tex}
    \caption{Path metrics with their standard error.}
    \label{tbl:path_reg}
\end{table}
